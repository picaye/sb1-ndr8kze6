import { MaritalStatus } from '../../types/TaxInfo';
...
// 2024 Federal Tax Rates (Direct Federal Tax - DBG)
...
export function calculateFederalTax(taxableIncome: number, maritalStatus: MaritalStatus): number {
  const brackets = maritalStatus === 'married' ? MARRIED_BRACKETS : SINGLE_BRACKETS;
  ...
  if (taxableIncome <= brackets[0].limit) {
    return 0;
  }
